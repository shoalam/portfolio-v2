        ...
        <div className="row">
          ...
          <div className="service-item padd-15">
            <div className="service-item-inner">
              ...
              <h4>Development</h4>
              <p>
                Is process of managing learning and work in order to move toward
                a determined and evolving future.
              </p>
            </div>
          </div>
          ...
          <div className="service-item padd-15">
            <div className="service-item-inner">
              ...
              <p>
                Is an approach to web design that makes web pages render well on
